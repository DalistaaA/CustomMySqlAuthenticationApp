package com.mysqlauthentication.config;
...
import com.mysqlauthentication.serviceImpl.UserInfoServiceImpl;
...
public class TopicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(userInfoServiceImpl).passwordEncoder(bCryptPasswordEncoder);
	}
